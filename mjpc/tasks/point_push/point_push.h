...
#ifndef MJPC_TASKS_POINT_PUSH_H_
#define MJPC_TASKS_POINT_PUSH_H_
...
namespace mjpc {
class PointPush : public Task {
 public:
  std::string Name() const override;
  std::string XmlPath() const override;
  class ResidualFn : public mjpc::BaseResidualFn {
   public:
    explicit ResidualFn(const PointPush* task) : mjpc::BaseResidualFn(task) {}
